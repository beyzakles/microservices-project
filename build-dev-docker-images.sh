./mvnw clean package #en son allerini alınması istendiği için her seferinde clean package yapılır (update için)
...
#ara containerlar --force-rm ile silinmesi için zorlanır, ara conteynerların gereksiz yer kaplaması engellenir. hata alan konteyner normalde silinmez troubleshoot için ancak force ile zorlayarak siler. ci/cd sürecinde aradaki hatalı container akışı engellememeli